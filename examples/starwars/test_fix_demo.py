...
def simulate_current_behavior():
    ...
    if os.path.exists("schema_graphql.graphql"):
        print("❓ Tool asks: 'There is already a file named 'schema_graphql.graphql' in the target location. Do you want to overwrite the file? [y/N]'")
        ...
        if user_input != 'y':
            ...
            with open(duplicate_name, 'w') as f:
                f.write("# Unwanted duplicate file created despite user saying 'No'\n# This is the UX problem!\n")
